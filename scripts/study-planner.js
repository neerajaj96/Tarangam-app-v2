/**
 * Node-side entry point for the canonical Deterministic Study Planning
 * Layer.
 *
 * The implementation lives in assets/study-planner.js so browsers and
 ...
 */
export * from '../assets/study-planner.js';
