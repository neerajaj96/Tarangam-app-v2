/**
 * Node-side entry point for the canonical Weak-Topic Analysis Layer.
 *
 * The implementation lives in assets/weak-topic-analysis.js so browsers and
 ...
 */
export * from '../assets/weak-topic-analysis.js';
