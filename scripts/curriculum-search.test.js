 ...
 * manifest-order tie-breaking, unknown queries, all-486 discoverability,
...
describe('live 486-topic repository', () => {
  ...
  it('keeps all 486 topics discoverable with deterministic ranked order', () => {
