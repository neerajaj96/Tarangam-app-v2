...
describe('manifest contents', () => {
  ...
  it('contains exactly 291 metadata topics', () => {
    assert.equal(manifest.topics.filter((t) => t.hasMetadata).length, 291);
    assert.equal(manifest.aggregates.metadataTopics, 291);
  });
