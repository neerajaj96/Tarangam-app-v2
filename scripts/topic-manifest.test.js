...
describe('manifest contents', () => {
  ...
  it('contains exactly 391 metadata topics', () => {
    assert.equal(manifest.topics.filter((t) => t.hasMetadata).length, 391);
    assert.equal(manifest.aggregates.metadataTopics, 391);
  });
