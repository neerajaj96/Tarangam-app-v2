...
describe('manifest contents', () => {
  ...
  it('contains exactly 141 metadata topics', () => {
    assert.equal(manifest.topics.filter((t) => t.hasMetadata).length, 141);
    assert.equal(manifest.aggregates.metadataTopics, 141);
  });
