...
describe('manifest contents', () => {
  ...
  it('contains exactly 114 metadata topics', () => {
    assert.equal(manifest.topics.filter((t) => t.hasMetadata).length, 114);
    assert.equal(manifest.aggregates.metadataTopics, 114);
  });
