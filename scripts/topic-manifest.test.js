...
describe('manifest contents', () => {
  ...
  it('contains exactly 316 metadata topics', () => {
    assert.equal(manifest.topics.filter((t) => t.hasMetadata).length, 316);
    assert.equal(manifest.aggregates.metadataTopics, 316);
  });
