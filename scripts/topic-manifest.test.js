...
describe('manifest contents', () => {
  ...
  it('contains exactly 341 metadata topics', () => {
    assert.equal(manifest.topics.filter((t) => t.hasMetadata).length, 341);
    assert.equal(manifest.aggregates.metadataTopics, 341);
  });
