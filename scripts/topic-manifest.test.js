...
describe('manifest contents', () => {
  ...
  it('contains exactly 367 metadata topics', () => {
    assert.equal(manifest.topics.filter((t) => t.hasMetadata).length, 367);
    assert.equal(manifest.aggregates.metadataTopics, 367);
  });
