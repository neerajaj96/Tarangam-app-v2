...
describe('manifest contents', () => {
  ...
  it('contains exactly 265 metadata topics', () => {
    assert.equal(manifest.topics.filter((t) => t.hasMetadata).length, 265);
    assert.equal(manifest.aggregates.metadataTopics, 265);
  });
